...
export const IconDuplicate = ({ className, color, width }) => {
  return (
...
export const IconEdit = ({ className, color, width }) => {
  return (
...
export const IconFilter = ({ className, color, width }) => {
  return (
...
export const IconFilterX = ({ className, color, width }) => {
  return (
    <svg className={className} width={width} fill={color} version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 122.88 107.128">
      <title>filter-x</title>
...
export const IconTrash = ({ className, color, width }) => {
  return (
...
export const IconVDots = ({ className, color, width = "auto" }) => {
  return (
...
export const IconHamburger = ({ className, color, width = "auto" }) => {
  return (
...
export const IconSortAsc = ({ className, color, width = "auto" }) => {
  return (
    <svg className={className} width={width} fill={color} id="Layer_1" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
      <title>v-dots</title>
...
export const IconSortDesc = ({ className, color, width = "auto" }) => {
  return (
    <svg className={className} width={width} fill={color} id="Layer_1" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
      <title>v-dots</title>
...
export const IconMagnifyingGlass = ({ className, color, width = "auto" }) => {
  return (
